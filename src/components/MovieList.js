...
class MovieList extends Component{
    ...
    {
        console.log("mount");
        const response=await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=8b441c93ffc0e4ad001b50874f633591&language=en-US&page=${this.state.currPage} `);
        ...
        return(
            ...
            <div className="movies-wrapper">
            {
                this.state.movies.map((movie)=>(
                    <>
                    <div className="card movie-board" onMouseEnter={()=>this.setState({hover:movie.id})} onMouseLeave={()=>this.setState({hover:""})}>
